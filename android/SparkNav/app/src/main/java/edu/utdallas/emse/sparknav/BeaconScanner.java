...
public class BeaconScanner {
    ...
    private static final long SCAN_TIME_MILLIS = 6 * 60 * 1000; //1000 = 1sec, 60 * 1000 = 1 min
    ...
    public BeaconScanner(Context mContext, Activity activity, WebView myWebView, String dst_loc_id, String emergencyLocation) {
        ...
        scanCallback = new ScanCallback() {
            ...
            public void onScanResult(int callbackType, ScanResult result) {
                ...
                String bName = beaconID.substring(18, 20);
                int rssi = result.getRssi();
                //Log.i(TAG, "==> id " + beaconID + ", rssi " + rssi);

                if( bName.equals("10") || bName.equals("11") || bName.equals("12") || bName.equals("13") ||
                        bName.equals("14") || bName.equals("15") || bName.equals("16") || bName.equals("1a") ||
                        bName.equals("1b") || bName.equals("1c") ) {
...
//            src_loc_id = getLocIdFromBeaconId( beaconId );
            if( emergencyLocation.equals("XXX") ) {
